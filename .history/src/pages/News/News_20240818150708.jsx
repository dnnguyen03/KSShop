...
import CarouselImage2 from '../../assets/image/img-news.png';
              ...
              <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src={CarouselImage1} class="d-block w-100" alt="banner"></img>
                  </div>
                  <div class="carousel-item">
                    <img src={CarouselImage2} class="d-block w-100" alt="banner"></img>
                  </div>
                  <div class="carousel-item">
                    <img src={CarouselImage1} class="d-block w-100" alt="banner"></img>
                  </div>
