...
export default function CardAuction(props) {
  ...
  return (
    <div className="CardAuction col-md-4">
      ...
      <h4 className="nameAuction">{title}</h4>
      <div>
        <div className="d-flex align-items-center justify-content-between">
          <div style={{ width: "100%" }}>
            <div className="card">
              <p className="text">
                <p>Giá khởi điểm:</p> <p>{startprice}₫</p>
              </p>
              <p className="text">
                <p>Bước giá: </p> <p>{stepprice}₫</p>
              </p>
              {endTime === true ? (
                <p className="text">
                  <p>Số lần đấu giá: </p> <p>{Solandaugia}</p>
                </p>
              ) : (
                <p className="text">
                  <p>Bắt đầu: </p> <p>{startTime}</p>
                </p>
              )}
              {endTime === true ? (
                <p
